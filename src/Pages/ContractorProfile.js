...
export default function ContractorProfile() {
  ...
  const fetchContractors = async () => {
    try {
      const contractorData = await API.graphql(
        graphqlOperation(listContractors)
      );
  ...
  const updateContractors = async (idx) => {
    try {
      ...
      const contractorData = await API.graphql(
        graphqlOperation(updateContractors, { input: contractor })
      );
          ...
          <div className="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
                    ...
                    <form action="#" method="POST">
                      ...
                      <div className="mt-5 md:mt-0 md:col-span-2">
                        <form
                          ...
                          action="#"
                          method="POST"
                          onSubmit={this.updateContractors(idx)}
                        >
                          {
                            //Avatar Photo
                          }
                      ...
                      <div>
                        ...
                        <div className="mt-1">
                          <textarea
                            ...
                            placeholder="Our company specializes in..."
                            defaultValue={""}
                          />
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="mt-1">
                          <textarea
                            ...
                            rows={5}
                            className="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border border-gray-300 rounded-md"
                            placeholder="We are qualified to work on ____ job sites."
                            defaultValue={""}
                          />
                        </div>
                      </div>
            ...
            <div className="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
              <div className="md:grid md:grid-cols-3 md:gap-6">
                <div className="md:col-span-1">
                  <h3 className="text-lg font-medium leading-6 text-gray-900">
                    Upload a demonstration of a previous job
                  </h3>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700">
                  ...
                  <div>
                    ...
                    <div className="mt-1">
                      <textarea
                        ...
                        rows={5}
                        className="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border border-gray-300 rounded-md"
                        placeholder="Explain what you have done in this job."
                        defaultValue={""}
                      />
                    </div>
                  </div>
                        ...
                        <div className="flex items-start">
                          <div className="h-5 flex items-center">
                            <input
                              ...
                              name="comments"
                              type="checkbox"
                              className="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded justifyContent: 'center'"
                            />
                          </div>
                          <div className="ml-3 text-sm">
                            <label
                              htmlFor="comments"
                              className="font-medium text-gray-700 text-align:center textAlignVertical:center textAlign: center"
                            >
                              Comments
                            </label>
                            <p className="text-gray-500 text-align:center;">
